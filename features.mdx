...
<Warning>
  These features are planned but not yet implemented in the alpha release:
</Warning>

- **Server Transfers**: Move servers between nodes
- **Mount System**: Shared directories across servers
- **Advanced Monitoring**: Grafana integration
- **Plugin System**: Extend panel functionality
